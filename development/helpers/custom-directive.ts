 ...
 */
export const applySchemaCustomDirectives: (schema: GraphQLSchema) => GraphQLSchema = function (schema) {
...
interface GenericDirective<T = {}, A = {}, K = {}> {
    name: string;
    description?: string;
    locations: DirectiveLocationEnum[];
    args: {};
...
export interface GraphQLCustomDirective {
    new <T = {}, K = {}, A = {}>(options: GenericDirective<T, K, A>): GraphQLDirective;
}
